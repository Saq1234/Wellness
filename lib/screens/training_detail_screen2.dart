...
class TrainingDetailList2 extends StatefulWidget {
  final StartTrainingModel traininglist;
  TrainingDetailList2(this.traininglist);

  @override
  State<TrainingDetailList2> createState() => _TrainingDetailList1State();
}

class _TrainingDetailList1State extends State<TrainingDetailList2> {
              ...
              Stack(
                children:[
                  Column(
                    ...
                    children: [
                      Center(
                        child: Text("Last Exercise",style: TextStyle(
                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            Spacer(),
                            Text("Just one more to go!",style: TextStyle(
                                color: Colors.grey,
                          ...
                          Row(
                            children: [
                              Container(
                                height:MediaQuery.of(context).size.height/14 ,
                                width:50,
                                child: Image.asset("assets/images/training4.jpg",fit: BoxFit.cover,),
                              ),
                              Padding(
                                ...
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text("Plank Leg Lift",style: TextStyle(
                                        fontSize: 20,
                                        color: Colors.grey,
                                        fontWeight: FontWeight.bold
                                    ),),
